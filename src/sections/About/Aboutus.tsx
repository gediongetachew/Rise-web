  ...
  return (
    <Grid container sx={{ mx: 12, width: "80%", marginBottom: { xs: 10 } }}>
      ...
      >
        <Card
          variant="outlined"
          sx={{ borderColor: "#D8D8D8", p: 3, width: "50%" }}
        >
          <CardContent>
            ...
            <Typography variant="body2" sx={{ mt: 1, fontSize: "1rem" }}>
              ...
              pellentesque fermentum quis eget vehicula eleifend eleifend orci.
              Faucibus sed elementum suspendisse felis lacus. In lectus vitae
              enim pulvinar sed vulputate.
            </Typography>
          </CardContent>
        </Card>
        ...
        >
          <CardContent>
            ...
            <Typography variant="body2" sx={{ mt: 1, fontSize: "1rem" }}>
              ...
              pellentesque fermentum quis eget vehicula eleifend eleifend orci.
              Faucibus sed elementum suspendisse felis lacus. In lectus vitae
              enim pulvinar sed vulputate. Ornare sit ridiculus sed massa et ut.
            </Typography>
          </CardContent>
        </Card>
      </Grid>
